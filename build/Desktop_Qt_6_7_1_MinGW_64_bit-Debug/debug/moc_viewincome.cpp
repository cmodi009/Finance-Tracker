...
struct qt_meta_stringdata_CLASSViewIncomeENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSViewIncomeENDCLASS = QtMocHelpers::stringData(
    "ViewIncome",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSViewIncomeENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ViewIncome::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSViewIncomeENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSViewIncomeENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSViewIncomeENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ViewIncome, std::true_type>,
...
void ViewIncome::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ViewIncome *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ViewIncome::*)(QString , QSqlTableModel * );
            if (_t _q_method = &ViewIncome::editTransactionClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ViewIncome::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSViewIncomeENDCLASS.stringdata0))
